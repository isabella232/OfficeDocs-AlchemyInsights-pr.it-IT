...
I record NS o CNAME delle impostazioni del dominio (DNS) non sono impostati correttamente. Per istruzioni dettagliate, è possibile fare riferimento a [creare record DNS presso qualsiasi provider di hosting DNS](https://docs.microsoft.com/office365/admin/get-help-with-domains/create-dns-records-at-any-dns-hosting-provider) . 
