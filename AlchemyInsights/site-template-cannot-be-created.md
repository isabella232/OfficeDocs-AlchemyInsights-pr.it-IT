...
---
# <a name="site-template-cannot-be-created"></a>Non è possibile creare il modello di sito

Il modello potrebbe avere una caratteristica mancante e non verrà attivato. Se la caratteristica non è disponibile per l'attivazione nella raccolta siti corrente, non è possibile usare il modello di sito per creare un sito.
...
Per informazioni più dettagliate sulle soluzioni e i problemi più comuni, vedere [Creare e usare modelli di sito](https://support.office.com/article/Create-and-use-site-templates-60371B0F-00E0-4C49-A844-34759EBDD989).
