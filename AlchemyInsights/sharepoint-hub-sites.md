...
Per ulteriori informazioni sui siti hub, vedere i seguenti elementi:
...
- [Associare un sito di SharePoint a un sito hub](https://support.office.com/article/associate-a-sharepoint-site-with-a-hub-site-ae0009fd-af04-4d3d-917d-88edb43efc05): informazioni su come associare siti esistenti a un sito hub dalla nuova interfaccia di amministrazione o PowerShell.

- [Rimozione di un sito hub](https://docs.microsoft.com/sharepoint/remove-hub-site): informazioni su come rimuovere un sito hub esistente nella nuova interfaccia di amministrazione o PowerShell.
