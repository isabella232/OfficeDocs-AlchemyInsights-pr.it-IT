...
Se si è un amministratore e si desidera importare in blocco più file PST nelle cassette postali di Microsoft 365, vedere [questo articolo](https://docs.microsoft.com/microsoft-365/security/office-365-security/use-dkim-to-validate-outbound-email).