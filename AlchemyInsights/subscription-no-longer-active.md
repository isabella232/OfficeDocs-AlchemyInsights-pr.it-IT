...
---
# <a name="subscription-no-longer-active"></a>Abbonamento non più attivo

Se quando si apre un'applicazione di Microsoft [compare un avviso relativo all'abbonamento](https://support.microsoft.com/office/a-subscription-notice-appears-when-i-open-a-microsoft-365-application-4cabe32c-f594-4c0e-9191-3d3ade10cceb), può essere necessario riattivare l'abbonamento.
