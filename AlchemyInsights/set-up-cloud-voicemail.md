...
- Sistema telefonico con ambienti locali: [configurare il servizio Cloud Voicemail per gli utenti locali](https://docs.microsoft.com/skypeforbusiness/hybrid/configure-cloud-voicemail) 
- [Piani di chiamata per Microsoft 365](https://docs.microsoft.com//microsoftteams/calling-plans-for-office-365) 
