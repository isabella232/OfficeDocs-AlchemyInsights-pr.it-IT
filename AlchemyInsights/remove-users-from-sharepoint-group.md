...
---
# <a name="remove-users-from-a-sharepoint-group"></a>Rimuovere utenti da un gruppo di SharePoint
...
- [Aggiungere o rimuovere membri dai gruppi di Microsoft 365 tramite l'interfaccia di amministrazione](https://docs.microsoft.com/microsoft-365/admin/create-groups/add-or-remove-members-from-groups)
