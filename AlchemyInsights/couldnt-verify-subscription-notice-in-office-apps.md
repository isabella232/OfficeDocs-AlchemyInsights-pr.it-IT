---
title: Non è possibile verificare l'avviso relativo all'abbonamento nelle app di Office
ms.author: pebaum
author: pebaum
manager: mnirkhe
ms.audience: Admin
...
ms.locfileid: "43182995"
---
# <a name="couldnt-verify-subscription-notice-in-office-apps"></a>Avviso "Non è possibile verificare l'abbonamento" nelle app di Office
...
- Controllare la [pagina di Office 365 sull'integrità dei servizi](https://docs.microsoft.com/office365/enterprise/view-service-health) per verificare se sono presenti problemi noti con il servizio.
