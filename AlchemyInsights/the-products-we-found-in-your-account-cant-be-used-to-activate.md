...
Per gli scenari di computer condivisi, vedere [risolvere i problemi relativi all'attivazione di computer condivisi per le app Microsoft 365 per Enterprise](https://docs.microsoft.com/deployoffice/troubleshoot-issues-with-shared-computer-activation-for-office-365-proplus).

Per altre informazioni, vedere: 
- [Quando si apre un'applicazione Microsoft 365, viene visualizzato un avviso di sottoscrizione](https://support.office.com/article/4cabe32c-f594-4c0e-9191-3d3ade10cceb)
