...
- È necessario utilizzare la funzionalità di ricerca del registro di controllo nel centro sicurezza & conformità per recuperare i log di controllo correlati a SharePoint e OneDrive. Per ulteriori informazioni, vedere [Search the audit log](https://docs.microsoft.com/office365/securitycompliance/search-the-audit-log-in-security-and-compliance#search-the-audit-log).
