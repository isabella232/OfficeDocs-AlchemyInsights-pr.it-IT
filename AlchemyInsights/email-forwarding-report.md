...
ms.locfileid: "36740253"
---
# <a name="email-forwarding-report"></a><span data-ttu-id="bba2d-102">Report sull’inoltro della posta elettronica</span><span class="sxs-lookup"><span data-stu-id="bba2d-102">Email forwarding report</span></span>

<span data-ttu-id="bba2d-103">Per visualizzare un report sul numero di messaggi di posta elettronica inoltrati automaticamente nell'organizzazione, vedere [Approfondimenti sul flusso di posta](https://docs.microsoft.com//office365/securitycompliance/mail-flow-insights-v2) nel [Centro sicurezza e conformità di Office 365](https://protection.office.com/#/homepage).</span><span class="sxs-lookup"><span data-stu-id="bba2d-103">To see a report on how many auto-forwarded messages there are in your organization, check [Mail flow insights](https://docs.microsoft.com//office365/securitycompliance/mail-flow-insights-v2) in the [Office 365 Security &amp; Compliance Center](https://protection.office.com/#/homepage).</span></span>
  
<span data-ttu-id="bba2d-104">Nota: se è la prima volta che si accede al Centro sicurezza e conformità, potrebbe essere necessario aggiornare il browser dopo alcuni minuti per visualizzare tutte le opzioni disponibili.</span><span class="sxs-lookup"><span data-stu-id="bba2d-104">Please note: if this is the first time you are logging into the Security &amp; Compliance Center, you might need to refresh the browser after a few minutes to see all of the available options.</span></span>
