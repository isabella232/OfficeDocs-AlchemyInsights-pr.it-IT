...
- [Gli errori di autenticazione si verificano quando il client non dispone del supporto di TLS 1.2](https://docs.microsoft.com/sharepoint/troubleshoot/administration/authentication-errors-tls12-support#network-drive-mapped-to-a-sharepoint-library)  
