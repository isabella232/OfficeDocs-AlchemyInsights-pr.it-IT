...
---
# <a name="steps-to-create-a-sharepoint-workflow"></a>Passaggi per la creazione di un flusso di lavoro di SharePoint

- Se non è possibile aggiungere un flusso di lavoro di approvazione di SharePoint 2010, vedere [non è possibile aggiungere il flusso di lavoro approvazione predefinito 2010](https://docs.microsoft.com/alchemyinsights/can-t-add-default-2010-approval-workflow).
- Come creare flussi di lavoro:
    - [2013 flusso di lavoro di SharePoint Designer](https://docs.microsoft.com/sharepoint/dev/general-development/creating-a-workflow-by-using-sharepoint-designer-and-the-sharepoint-wo)
    - [2010 flusso di lavoro di SharePoint Designer](https://support.office.com/article/introduction-to-designing-and-customizing-workflows-32c9c0bf-5e20-4f74-8b9c-d3ea79f2962b)
