...
- Nella pagina siti della nuova interfaccia di amministrazione di SharePoint fare clic su **Crea**. 
    
 **Nota:** Non è possibile creare un nuovo sito che abbia lo stesso URL con un sito esistente. 
  
Per ulteriori informazioni sulla creazione di un sito, vedere [creare un sito](https://go.microsoft.com/fwlink/?linkid=866295).
