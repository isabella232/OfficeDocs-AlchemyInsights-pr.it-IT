...
Microsoft 365 Business Premium, Microsoft 365 Education, Microsoft 365 e Enterprise forniscono licenze digitali per Windows 10 come parte dell'abbonamento. Per attivare l'abbonamento, è necessario che per il dispositivo sia già stato attivato Windows 10 Pro (1703 o versioni successive). Per visualizzare un elenco completo dei requisiti per l'attivazione di una sottoscrizione di Windows 10, vedere [requisiti di attivazione della sottoscrizione di Windows 10](https://docs.microsoft.com/windows/deployment/windows-10-subscription-activation#requirements).
