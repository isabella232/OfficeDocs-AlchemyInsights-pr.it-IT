...
---
# <a name="set-up-windows-virtual-desktop"></a>Configurare desktop virtuale di Windows
...
La [Guida all'installazione di Windows Virtual Desktop](https://go.microsoft.com/fwlink/?linkid=2146236) fornisce agli amministratori le risorse di pianificazione e i prerequisiti per la distribuzione, le indicazioni di installazione e le risorse aggiuntive.
