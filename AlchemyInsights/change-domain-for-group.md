...
Dopo che il gruppo Microsoft 365 è già stato creato, non esiste alcun modo per modificare il dominio. L'unico modo consiste nel creare un nuovo gruppo di Microsoft 365 ed eliminare quello precedente, se necessario (è possibile aggiungere ulteriori indirizzi di posta elettronica tramite l'interfaccia di [amministrazione di Exchange](https://outlook.office365.com/ecp.aspx)).