...
ms.locfileid: "43759984"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="58821-102">Accedere alla pagina Domains</span><span class="sxs-lookup"><span data-stu-id="58821-102">Access the Domains Page</span></span>

<span data-ttu-id="58821-103">Per accedere alla pagina dei domini, è sufficiente fare clic sull'icona seguente:</span><span class="sxs-lookup"><span data-stu-id="58821-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="58821-104">È quindi possibile aggiungere, modificare o rimuovere il dominio.</span><span class="sxs-lookup"><span data-stu-id="58821-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="58821-105">Per ulteriori informazioni, vedere le [domande frequenti sui domini.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="58821-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/office365/admin/setup/domains-faq)</span></span>
