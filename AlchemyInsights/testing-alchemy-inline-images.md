...
ms.locfileid: "44505059"
---
# <a name="access-the-domains-page"></a><span data-ttu-id="ab1d3-102">Accedere alla pagina Domains</span><span class="sxs-lookup"><span data-stu-id="ab1d3-102">Access the Domains Page</span></span>

<span data-ttu-id="ab1d3-103">Per accedere alla pagina dei domini, è sufficiente fare clic sull'icona seguente:</span><span class="sxs-lookup"><span data-stu-id="ab1d3-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="ab1d3-104">È quindi possibile aggiungere, modificare o rimuovere il dominio.</span><span class="sxs-lookup"><span data-stu-id="ab1d3-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="ab1d3-105">Per ulteriori informazioni, vedere le [domande frequenti sui domini.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="ab1d3-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
