...
ms.locfileid: "50736401"
---
# <a name="create-a-sensitivity-label"></a><span data-ttu-id="0f5ce-102">Creare un'etichetta di riservatezza</span><span class="sxs-lookup"><span data-stu-id="0f5ce-102">Create a sensitivity label</span></span>

<span data-ttu-id="0f5ce-103">Per creare un'etichetta di riservatezza, eseguire i passaggi seguenti:</span><span class="sxs-lookup"><span data-stu-id="0f5ce-103">To create a sensitivity label, perform the following steps:</span></span>
